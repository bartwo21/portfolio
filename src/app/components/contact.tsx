        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-5xl font-extralight tracking-tight text-white">
              Let&apos;s <span className="font-serif italic text-sky-200">Connect</span>
            </h2>
            <p className="text-sky-100/40 text-xs tracking-[0.4em] uppercase font-black">Open for new horizons</p>
          </div>
