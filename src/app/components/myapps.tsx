...
const MyApps: React.FC = () => {
  ...
  return (
    <div id="my-apps" ref={ref} className="cards flex flex-col w-full gap-12 mb-20">
      <div className="relative flex flex-col items-center">
        ...
        <motion.h1
          ...
          className="text-4xl md:text-5xl font-extralight tracking-tight text-white mb-8"
        >
      ...
      {myAppsData?.map((data, index) => (
        ...
        >
          ...
          >
            <div
              className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 backdrop-blur-2xl p-8 md:p-12 flex flex-col lg:flex-row gap-12 items-center transition-all duration-700 hover:bg-white/10 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.3)]"
            >
              ...
              <div className="relative w-full lg:w-[450px] aspect-video overflow-hidden rounded-2xl border border-white/10 shadow-2xl">
                <Link href={data.live_url} target="_blank" className="block w-full h-full">
                  <Image
                    src={data.img ?? ""}
                    alt={data.name}
                    fill
