      ...
      <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/[0.02] backdrop-blur-3xl p-8 md:p-14 shadow-2xl">
        ...
        <div className="relative z-10 space-y-12">
          <div className="text-center space-y-4">
            <h2 className="text-4xl font-extralight tracking-tight text-white">Professional <span className="font-serif italic text-sky-200">Path</span></h2>
            <p className="text-sky-100/40 text-sm tracking-[0.3em] uppercase font-bold">Career Timeline</p>
          </div>
              ...
              {uniqueCompanies.map((company) => {
                ...
                return (
                  <button
                    ...
                    className={`relative flex flex-col items-start px-6 py-5 rounded-2xl transition-all duration-500 min-w-[200px] text-left border ${isSelected
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      {selectedExperience.description.map((item, index) => {
                        ...
                        return (
                          <p key={index} className="text-sky-100/50 text-lg font-light leading-relaxed max-w-3xl">
                            {item}
                          </p>
                        );
                      })}
